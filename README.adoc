...
* [ ] Connect to the instance using OAUTH and TLS.
* [ ] Configure `input-high`, `input-low`, `input-high.DLT`, `input-low.DLT`, `left`, and `right` topics (with partitions, replication, and retention settings).
